...
_SPU2callback g_SPU2callback;

_DMA4callback g_DMA4callback;

_DMA7callback g_DMA7callback;
...
s32 SPU2init()
{
	...
	std::wstring omodid(L"dsound");
	
	// find the driver index of this module:
	OutputModule = FindOutputModuleById(omodid.c_str());
