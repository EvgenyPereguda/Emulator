...
namespace PCSX2Lib
{
	namespace API
	{
		...
		typedef int32(CALLBACK *_GSopen2)(void *pDsp, uint32 flags);
		...
		typedef void(CALLBACK *_GSinitReadFIFO2)(uint8 *pMem, uint32 qwc);
		typedef void(CALLBACK *_GSreadFIFO2)(uint8 *pMem, uint32 qwc);
		typedef void(CALLBACK *_GSgifSoftReset)(uint32 mask);


		// SPU2
		typedef s32(CALLBACK *_SPU2_Reset)();
		...
		typedef void(CALLBACK *_SPU2finishDMACallback)(void(*SPU2writeCallback)(int32 counter), void(*SPU2readCallback)(int32 counter));
		typedef void(CALLBACK *_SPU2TimeUpdateCallback)(void(*SPU2writeCallback)(int32 counter));
		...
		struct SPU2_API
		{
			...
			_SPU2finishDMACallback SPU2finishDMACallback;
			_SPU2TimeUpdateCallback SPU2TimeUpdateCallback;
		};
