...
namespace PCSX2Emul.Util
{
    ...
    class PCSX2LibNative
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void FourteenthDelegate(IntPtr a_FirstArg, Int32 a_SecondArg, IntPtr a_ThirdArg, IntPtr a_FourthArg);        
        ...
        public FourteenthDelegate setLoadBIOSCallbackCallback { set { m_PCSX2Init.setLoadBIOSCallbackCallback(System.Runtime.InteropServices.Marshal.GetFunctionPointerForDelegate(value)); } }
