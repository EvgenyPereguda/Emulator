...
namespace PCSX2Emul
{
    public class EmulInstance
    {
        ...
        private void Bind()
        {
            ...
            PCSX2LibNative.Instance.setLoadBIOSCallbackCallback = delegate (IntPtr a_FirstArg, Int32 a_SecondArg, IntPtr a_ThirdArg, IntPtr a_FourthArg)
            {
                Marshal.Copy(new int[] { EmulInstance.InternalInstance.VersionInt }, 0, a_FourthArg, 1);

                BiosControl.LoadBIOS(a_FirstArg, a_SecondArg, a_ThirdArg);
            };
        ...
        private void reset()
        {
            ...
            m_Pcsx2Config.CdvdVerboseReads = false;
            ...
            m_Pcsx2Config.FullBootConfig = false;
            ...
            m_Pcsx2Config.Speedhacks.vu1Instant = true;
